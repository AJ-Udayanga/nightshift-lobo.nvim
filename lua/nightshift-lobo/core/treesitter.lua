...
function M.load()
  ...
  local groups = {
    ...
    ["@markup.strong.markdown"] = { fg = c.red, bold = true },
    ["@markup.strong.markdown_inline"] = { fg = c.red, bold = true },
    ["@markup.italic.markdown"] = { fg = c.red, italic = true },
    ["@markup.italic.markdown_inline"] = { fg = c.red, italic = true },
    ["@markup.strikethrough.markdown"] = { fg = c.overlay1, strikethrough = true },
    ["@markup.strikethrough.markdown_inline"] = { fg = c.overlay1, strikethrough = true },
